...
[TR,E] = trainhmm(numStates,mfcc1);

% Train a HMM for each speaker
hmm1 = hmmtrain(mfcc1, TR, E);
[TR,E] = trainhmm(numStates,mfcc2);
hmm2 = hmmtrain(mfcc2, TR, E);
[TR,E] = trainhmm(numStates,mfcc3);
hmm3 = hmmtrain(mfcc3, TR, E);
